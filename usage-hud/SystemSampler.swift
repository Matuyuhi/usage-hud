...
final class SystemSampler {
    ...
    // ⚡ Bolt: Cache mach port and kernel page size to avoid resource leaks and redundant syscalls in polling loop
    ...
    init() {
        ...
        host_page_size(self.hostPort, &kernelPageSize)
        self.pageSize = UInt64(kernelPageSize)
    }
